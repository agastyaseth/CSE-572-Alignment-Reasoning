...
#SBATCH -o /scratch/aseth7/DM-Project/CSE-572-Alignment-Reasoning/Trainer/logs/run_trainer.out                       # STDOUT (%j = JobId)
#SBATCH -e /scratch/aseth7/DM-Project/CSE-572-Alignment-Reasoning/Trainer/logs/run_trainer.err                       # STDERR (%j = JobId)
##SBATCH -A aseth7                       # Account hours will be pulled from (commented out with double # in front)
#SBATCH --mail-type=ALL                 # Send a notification when the job starts, stops, or fails
#SBATCH --mail-user=aseth7@asu.edu       # send-to address
